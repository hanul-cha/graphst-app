...
export type CommentPaginationQuery = { __typename?: 'Query', comments?: { __typename?: 'commentPaginate', totalCount: number, nodes: Array<{ __typename?: 'Comment', contents: string, countLike: number, countUnlike: number, isLike: boolean, isUnlike: boolean, isMyComment: boolean, user: { __typename?: 'User', name: string } }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean } } | null };
...
export type CreateCommentMutation = { __typename?: 'Mutation', comment: { __typename?: 'Comment', contents: string, countLike: number, countUnlike: number, isLike: boolean, isUnlike: boolean, isMyComment: boolean, user: { __typename?: 'User', name: string } } };
...
export type PostDetailFragment = { __typename?: 'Post', title: string, contents: string, createAt: number, updateAt: number, activeAt: boolean, user: { __typename?: 'User', id: string, name: string, isLike: boolean, countFollower: number, countPost: number }, category?: { __typename?: 'Category', id: string, label: string } | null };
...
export type GetPostQuery = { __typename?: 'Query', getPost?: { __typename?: 'Post', title: string, contents: string, createAt: number, updateAt: number, activeAt: boolean, user: { __typename?: 'User', id: string, name: string, isLike: boolean, countFollower: number, countPost: number }, category?: { __typename?: 'Category', id: string, label: string } | null } | null };
...
export type CommentFullFragment = { __typename?: 'Comment', contents: string, countLike: number, countUnlike: number, isLike: boolean, isUnlike: boolean, isMyComment: boolean, user: { __typename?: 'User', name: string } };
