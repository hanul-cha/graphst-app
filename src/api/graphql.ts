...
export type PostInPageFragment = { __typename?: 'Post', id: string, title: string, contents: string, countLike: number, isLike: boolean, activeAt: boolean, countComment: number, user: { __typename?: 'User', id: string, name: string }, category?: { __typename?: 'Category', id: string, label: string } | null };
...
export type PostPaginationQuery = { __typename?: 'Query', posts?: { __typename?: 'postPaginate', totalCount: number, nodes: Array<{ __typename?: 'Post', id: string, title: string, contents: string, countLike: number, isLike: boolean, activeAt: boolean, countComment: number, user: { __typename?: 'User', id: string, name: string }, category?: { __typename?: 'Category', id: string, label: string } | null }>, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean } } | null };
